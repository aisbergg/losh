...
type AddBoundingBoxDimensionsPayload struct {
	BoundingBoxDimensions []*BoundingBoxDimensions `json:"boundingBoxDimensions,omitempty"`
	NumUids               *int64                   `json:"numUids,omitempty"`
}
...
type AddComponentInput struct {
	...
	DataSource    *ComponentSourceRef `json:"dataSource,omitempty"`
	//  The unique human readable identifier of the component in the format: `domain.tld/owner/repo/file-path/component-name/version`. For example:
	// - `github.com/aisbergg/foobar/okh.yml/baz/1.0.0`
	// - `wikifactory.com/aisbergg/foobar/-/baz/1.0.0`
	// - `oshwa.org/-/-/us000000.html/baz/1.0.0`
	Xid string `json:"xid"`
	...
	Repository         *ComponentSourceRef `json:"repository,omitempty"`
...
type AddComponentSourceInput struct {
	// The human readable identifier of the object.
	Xid string `json:"xid"`
	...
	Name string `json:"name"`
	// The tag of the repository, if any. (might be a Git tag or branch name)
	Tag *string `json:"tag,omitempty"`
	// The path of the manifest file or other resource inside the repository, if any.
	Path string `json:"path"`
}

type AddComponentSourcePayload struct {
...
type AddFloatVPayload struct {
	FloatV  []*FloatV `json:"floatV,omitempty"`
	NumUids *int64    `json:"numUids,omitempty"`
}
...
type AddManufacturingProcessPayload struct {
	ManufacturingProcess []*ManufacturingProcess `json:"manufacturingProcess,omitempty"`
	NumUids              *int64                  `json:"numUids,omitempty"`
}
...
type AddOpenSCADDimensionsPayload struct {
	OpenSCADDimensions []*OpenSCADDimensions `json:"openSCADDimensions,omitempty"`
	NumUids            *int64                `json:"numUids,omitempty"`
}
...
type AddStringVPayload struct {
	StringV []*StringV `json:"stringV,omitempty"`
	NumUids *int64     `json:"numUids,omitempty"`
}
...
type AddTechnicalStandardPayload struct {
	TechnicalStandard []*TechnicalStandard `json:"technicalStandard,omitempty"`
	NumUids           *int64               `json:"numUids,omitempty"`
}
...
type AddTechnologySpecificDocumentationCriteriaPayload struct {
	TechnologySpecificDocumentationCriteria []*TechnologySpecificDocumentationCriteria `json:"technologySpecificDocumentationCriteria,omitempty"`
	NumUids                                 *int64                                     `json:"numUids,omitempty"`
}
...
type BoundingBoxDimensionsAggregateResult struct {
	...
	HeightSum *float64 `json:"heightSum,omitempty"`
	HeightAvg *float64 `json:"heightAvg,omitempty"`
	WidthMin  *float64 `json:"widthMin,omitempty"`
	WidthMax  *float64 `json:"widthMax,omitempty"`
	WidthSum  *float64 `json:"widthSum,omitempty"`
	WidthAvg  *float64 `json:"widthAvg,omitempty"`
	DepthMin  *float64 `json:"depthMin,omitempty"`
	DepthMax  *float64 `json:"depthMax,omitempty"`
	DepthSum  *float64 `json:"depthSum,omitempty"`
	DepthAvg  *float64 `json:"depthAvg,omitempty"`
}
...
type Category struct {
	...
	ChildrenAggregate *CategoryAggregateResult `json:"childrenAggregate,omitempty"`
	ProductsAggregate *ProductAggregateResult  `json:"productsAggregate,omitempty"`
}
...
type CategoryAggregateResult struct {
	Count          *int64  `json:"count,omitempty"`
	XidMin         *string `json:"xidMin,omitempty"`
	XidMax         *string `json:"xidMax,omitempty"`
	FullNameMin    *string `json:"fullNameMin,omitempty"`
	FullNameMax    *string `json:"fullNameMax,omitempty"`
...
type Component struct {
	...
	Owner UserOrGroup `json:"owner,omitempty"`
	// The version string of the release.
	Version string `json:"version"`
	// The date and time when the release was created.
	CreatedAt time.Time `json:"createdAt"`
	// A list of all releases of the component.
	Releases []*Component `json:"releases,omitempty"`
	// Indicates if this release is the latest release of the component.
	IsLatest bool `json:"isLatest"`
	// The repository that this component is developed in.
	Repository *ComponentSource `json:"repository,omitempty"`
	// The license used for the component.
	License *License `json:"license,omitempty"`
	// The additional licenses used for the documentation and other assets, if any.
	AdditionalLicenses []*License `json:"additionalLicenses,omitempty"`
	// The license holder of the component.
	Licensor UserOrGroup `json:"licensor,omitempty"`
	// The language in which the documentation is written.
	DocumentationLanguage *string `json:"documentationLanguage,omitempty"`
	// The OSH technology readiness level (OTRL) of the component. For information see:
	// https://github.com/OPEN-NEXT/OKH-LOSH/blob/master/OTRL.md
	...
	Tsdc *TechnologySpecificDocumentationCriteria `json:"tsdc,omitempty"`
	...
	ProductionMetadata          []*KeyValue               `json:"productionMetadata,omitempty"`
	ReleasesAggregate           *ComponentAggregateResult `json:"releasesAggregate,omitempty"`
	AdditionalLicensesAggregate *LicenseAggregateResult   `json:"additionalLicensesAggregate,omitempty"`
	ComponentsAggregate         *ComponentAggregateResult `json:"componentsAggregate,omitempty"`
	SoftwareAggregate           *SoftwareAggregateResult  `json:"softwareAggregate,omitempty"`
	UsedInAggregate             *ComponentAggregateResult `json:"usedInAggregate,omitempty"`
	ExportAggregate             *FileAggregateResult      `json:"exportAggregate,omitempty"`
	AuxiliaryAggregate          *FileAggregateResult      `json:"auxiliaryAggregate,omitempty"`
	ProductionMetadataAggregate *KeyValueAggregateResult  `json:"productionMetadataAggregate,omitempty"`
}
...
type ComponentAggregateResult struct {
	Count                    *int64     `json:"count,omitempty"`
	DiscoveredAtMin          *time.Time `json:"discoveredAtMin,omitempty"`
	DiscoveredAtMax          *time.Time `json:"discoveredAtMax,omitempty"`
	LastIndexedAtMin         *time.Time `json:"lastIndexedAtMin,omitempty"`
	LastIndexedAtMax         *time.Time `json:"lastIndexedAtMax,omitempty"`
	XidMin                   *string    `json:"xidMin,omitempty"`
	XidMax                   *string    `json:"xidMax,omitempty"`
	NameMin                  *string    `json:"nameMin,omitempty"`
	NameMax                  *string    `json:"nameMax,omitempty"`
	DescriptionMin           *string    `json:"descriptionMin,omitempty"`
	DescriptionMax           *string    `json:"descriptionMax,omitempty"`
	VersionMin               *string    `json:"versionMin,omitempty"`
	VersionMax               *string    `json:"versionMax,omitempty"`
	CreatedAtMin             *time.Time `json:"createdAtMin,omitempty"`
	CreatedAtMax             *time.Time `json:"createdAtMax,omitempty"`
	DocumentationLanguageMin *string    `json:"documentationLanguageMin,omitempty"`
	DocumentationLanguageMax *string    `json:"documentationLanguageMax,omitempty"`
	AttestationMin           *string    `json:"attestationMin,omitempty"`
	...
	MassMax                  *float64   `json:"massMax,omitempty"`
	MassSum                  *float64   `json:"massSum,omitempty"`
	MassAvg                  *float64   `json:"massAvg,omitempty"`
}
...
func (ComponentSource) IsNode() {}

type ComponentSourceAggregateResult struct {
	Count       *int64  `json:"count,omitempty"`
	XidMin      *string `json:"xidMin,omitempty"`
	XidMax      *string `json:"xidMax,omitempty"`
	URLMin      *string `json:"urlMin,omitempty"`
	URLMax      *string `json:"urlMax,omitempty"`
	PermaURLMin *string `json:"permaUrlMin,omitempty"`
	PermaURLMax *string `json:"permaUrlMax,omitempty"`
	NameMin     *string `json:"nameMin,omitempty"`
	NameMax     *string `json:"nameMax,omitempty"`
	TagMin      *string `json:"tagMin,omitempty"`
	TagMax      *string `json:"tagMax,omitempty"`
	PathMin     *string `json:"pathMin,omitempty"`
	PathMax     *string `json:"pathMax,omitempty"`
}

type ComponentSourceFilter struct {
	ID   []string                                                `json:"id,omitempty"`
	Xid  *StringHashFilter                                       `json:"xid,omitempty"`
	Name *StringFullTextFilterStringHashFilterStringRegExpFilter `json:"name,omitempty"`
	Has  []*ComponentSourceHasFilter                             `json:"has,omitempty"`
	And  []*ComponentSourceFilter                                `json:"and,omitempty"`
	Or   []*ComponentSourceFilter                                `json:"or,omitempty"`
	Not  *ComponentSourceFilter                                  `json:"not,omitempty"`
}

type ComponentSourceOrder struct {
	Asc  *ComponentSourceOrderable `json:"asc,omitempty"`
	Desc *ComponentSourceOrderable `json:"desc,omitempty"`
	Then *ComponentSourceOrder     `json:"then,omitempty"`
}

type ComponentSourcePatch struct {
	// The human readable identifier of the object.
	Xid *string `json:"xid,omitempty"`
	// The repository URL where the component was discoverd from or is developed in.
	URL *string `json:"url,omitempty"`
...
type ComponentSourceRef struct {
	ID *string `json:"id,omitempty"`
	// The human readable identifier of the object.
	Xid *string `json:"xid,omitempty"`
	// The repository URL where the component was discoverd from or is developed in.
...
type DeleteComponentSourcePayload struct {
	ComponentSource []*ComponentSource `json:"componentSource,omitempty"`
	Msg             *string            `json:"msg,omitempty"`
	NumUids         *int64             `json:"numUids,omitempty"`
}
...
type DeleteCrawlerMetaPayload struct {
	CrawlerMeta []CrawlerMeta `json:"crawlerMeta,omitempty"`
	Msg         *string       `json:"msg,omitempty"`
	NumUids     *int64        `json:"numUids,omitempty"`
}
...
type DeleteUserOrGroupPayload struct {
	UserOrGroup []UserOrGroup `json:"userOrGroup,omitempty"`
	Msg         *string       `json:"msg,omitempty"`
	NumUids     *int64        `json:"numUids,omitempty"`
}
...
type FileAggregateResult struct {
	...
	PathMin          *string    `json:"pathMin,omitempty"`
	PathMax          *string    `json:"pathMax,omitempty"`
	MimeTypeMin      *string    `json:"mimeTypeMin,omitempty"`
	MimeTypeMax      *string    `json:"mimeTypeMax,omitempty"`
	URLMin           *string    `json:"urlMin,omitempty"`
	URLMax           *string    `json:"urlMax,omitempty"`
	CreatedAtMin     *time.Time `json:"createdAtMin,omitempty"`
	CreatedAtMax     *time.Time `json:"createdAtMax,omitempty"`
...
type Group struct {
	...
	Products          []*Product                  `json:"products,omitempty"`
	ID                string                      `json:"id"`
	Members           []UserOrGroup               `json:"members,omitempty"`
	MemberOfAggregate *GroupAggregateResult       `json:"memberOfAggregate,omitempty"`
	ProductsAggregate *ProductAggregateResult     `json:"productsAggregate,omitempty"`
	MembersAggregate  *UserOrGroupAggregateResult `json:"membersAggregate,omitempty"`
}
...
type HostAggregateResult struct {
	Count     *int64  `json:"count,omitempty"`
	DomainMin *string `json:"domainMin,omitempty"`
	DomainMax *string `json:"domainMax,omitempty"`
	NameMin   *string `json:"nameMin,omitempty"`
	NameMax   *string `json:"nameMax,omitempty"`
}
...
type KeyValue struct {
	ID    string        `json:"id"`
	Key   *string       `json:"key,omitempty"`
	Value StringOrFloat `json:"value,omitempty"`
}
...
type KeyValueAggregateResult struct {
	Count  *int64  `json:"count,omitempty"`
	KeyMin *string `json:"keyMin,omitempty"`
	KeyMax *string `json:"keyMax,omitempty"`
}
...
type LicenseAggregateResult struct {
	...
	DetailsURLMax   *string `json:"detailsURLMax,omitempty"`
}
...
type OpenSCADDimensionsAggregateResult struct {
	Count       *int64  `json:"count,omitempty"`
	OpenscadMin *string `json:"openscadMin,omitempty"`
	OpenscadMax *string `json:"openscadMax,omitempty"`
	UnitMin     *string `json:"unitMin,omitempty"`
	UnitMax     *string `json:"unitMax,omitempty"`
}
...
type Product struct {
	...
	Category          *Category                 `json:"category,omitempty"`
	ReleasesAggregate *ComponentAggregateResult `json:"releasesAggregate,omitempty"`
	ForksAggregate    *ProductAggregateResult   `json:"forksAggregate,omitempty"`
	TagsAggregate     *TagAggregateResult       `json:"tagsAggregate,omitempty"`
}
...
type ProductAggregateResult struct {
	...
	DescriptionMin   *string    `json:"descriptionMin,omitempty"`
	DescriptionMax   *string    `json:"descriptionMax,omitempty"`
	WebsiteMin       *string    `json:"websiteMin,omitempty"`
	WebsiteMax       *string    `json:"websiteMax,omitempty"`
	VersionMin       *string    `json:"versionMin,omitempty"`
	VersionMax       *string    `json:"versionMax,omitempty"`
}
...
type Software struct {
	...
	ID                    string           `json:"id"`
	Release               *string          `json:"release,omitempty"`
	InstallationGuide     *File            `json:"installationGuide,omitempty"`
	DocumentationLanguage *string          `json:"documentationLanguage,omitempty"`
	License               *License         `json:"license,omitempty"`
	Licensor              *string          `json:"licensor,omitempty"`
}
...
type SoftwareAggregateResult struct {
	...
	DocumentationLanguageMin *string    `json:"documentationLanguageMin,omitempty"`
	DocumentationLanguageMax *string    `json:"documentationLanguageMax,omitempty"`
	LicensorMin              *string    `json:"licensorMin,omitempty"`
	LicensorMax              *string    `json:"licensorMax,omitempty"`
}
...
type Tag struct {
	...
	Aliases []*Tag `json:"aliases,omitempty"`
	// List of related tags.
	Related          []*Tag              `json:"related,omitempty"`
	AliasesAggregate *TagAggregateResult `json:"aliasesAggregate,omitempty"`
	RelatedAggregate *TagAggregateResult `json:"relatedAggregate,omitempty"`
}
...
type TechnologySpecificDocumentationCriteriaAggregateResult struct {
	...
	RequirementsURIMin *string `json:"requirementsUriMin,omitempty"`
	RequirementsURIMax *string `json:"requirementsUriMax,omitempty"`
}
...
type UpdateBoundingBoxDimensionsInput struct {
	Filter *BoundingBoxDimensionsFilter `json:"filter,omitempty"`
...
type UpdateComponentSourceInput struct {
	Filter *ComponentSourceFilter `json:"filter,omitempty"`
	Set    *ComponentSourcePatch  `json:"set,omitempty"`
	Remove *ComponentSourcePatch  `json:"remove,omitempty"`
}

type UpdateComponentSourcePayload struct {
	ComponentSource []*ComponentSource `json:"componentSource,omitempty"`
	NumUids         *int64             `json:"numUids,omitempty"`
}

type UpdateCrawlerMetaInput struct {
	Filter *CrawlerMetaFilter `json:"filter,omitempty"`
...
type UpdateFloatVInput struct {
	Filter *FloatVFilter `json:"filter,omitempty"`
...
type UpdateKeyValueInput struct {
	Filter *KeyValueFilter `json:"filter,omitempty"`
...
type UpdateLicenseInput struct {
	Filter *LicenseFilter `json:"filter,omitempty"`
...
type UpdateManufacturingProcessInput struct {
	Filter *ManufacturingProcessFilter `json:"filter,omitempty"`
...
type UpdateOpenSCADDimensionsInput struct {
	Filter *OpenSCADDimensionsFilter `json:"filter,omitempty"`
...
type UpdateSoftwareInput struct {
	Filter *SoftwareFilter `json:"filter,omitempty"`
...
type UpdateStringVInput struct {
	Filter *StringVFilter `json:"filter,omitempty"`
...
type UpdateTechnicalStandardInput struct {
	Filter *TechnicalStandardFilter `json:"filter,omitempty"`
...
type UpdateTechnologySpecificDocumentationCriteriaInput struct {
	Filter *TechnologySpecificDocumentationCriteriaFilter `json:"filter,omitempty"`
...
type UpdateUserOrGroupInput struct {
	Filter *UserOrGroupFilter `json:"filter,omitempty"`
...
type UserAggregateResult struct {
	...
	FullNameMin *string `json:"fullNameMin,omitempty"`
	FullNameMax *string `json:"fullNameMax,omitempty"`
	LocaleMin   *string `json:"localeMin,omitempty"`
	LocaleMax   *string `json:"localeMax,omitempty"`
}
...
type UserOrGroupPatch struct {
	// The unique human readable identifier of the owner. For example: `github.com/aisbergg`
	Xid      *string       `json:"xid,omitempty"`
	Host     *HostRef      `json:"host,omitempty"`
	Name     *string       `json:"name,omitempty"`
	Email    *string       `json:"email,omitempty"`
...
const (
	...
	ComponentHasFilterOwner                       ComponentHasFilter = "owner"
...
type ComponentSourceHasFilter string

const (
	ComponentSourceHasFilterXid      ComponentSourceHasFilter = "xid"
	ComponentSourceHasFilterURL      ComponentSourceHasFilter = "url"
	ComponentSourceHasFilterPermaURL ComponentSourceHasFilter = "permaUrl"
	ComponentSourceHasFilterHost     ComponentSourceHasFilter = "host"
	ComponentSourceHasFilterOwner    ComponentSourceHasFilter = "owner"
	ComponentSourceHasFilterName     ComponentSourceHasFilter = "name"
	ComponentSourceHasFilterTag      ComponentSourceHasFilter = "tag"
	ComponentSourceHasFilterPath     ComponentSourceHasFilter = "path"
)

var AllComponentSourceHasFilter = []ComponentSourceHasFilter{
	ComponentSourceHasFilterXid,
	ComponentSourceHasFilterURL,
	ComponentSourceHasFilterPermaURL,
	ComponentSourceHasFilterHost,
	ComponentSourceHasFilterOwner,
	ComponentSourceHasFilterName,
	ComponentSourceHasFilterTag,
	ComponentSourceHasFilterPath,
}

func (e ComponentSourceHasFilter) IsValid() bool {
	switch e {
	case ComponentSourceHasFilterXid, ComponentSourceHasFilterURL, ComponentSourceHasFilterPermaURL, ComponentSourceHasFilterHost, ComponentSourceHasFilterOwner, ComponentSourceHasFilterName, ComponentSourceHasFilterTag, ComponentSourceHasFilterPath:
		return true
	}
	return false
}

func (e ComponentSourceHasFilter) String() string {
	return string(e)
}

func (e *ComponentSourceHasFilter) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = ComponentSourceHasFilter(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid ComponentSourceHasFilter", str)
	}
	return nil
}

func (e ComponentSourceHasFilter) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

type ComponentSourceOrderable string

const (
	ComponentSourceOrderableXid      ComponentSourceOrderable = "xid"
	ComponentSourceOrderableURL      ComponentSourceOrderable = "url"
	ComponentSourceOrderablePermaURL ComponentSourceOrderable = "permaUrl"
	ComponentSourceOrderableName     ComponentSourceOrderable = "name"
	ComponentSourceOrderableTag      ComponentSourceOrderable = "tag"
	ComponentSourceOrderablePath     ComponentSourceOrderable = "path"
)

var AllComponentSourceOrderable = []ComponentSourceOrderable{
	ComponentSourceOrderableXid,
	ComponentSourceOrderableURL,
	ComponentSourceOrderablePermaURL,
	ComponentSourceOrderableName,
	ComponentSourceOrderableTag,
	ComponentSourceOrderablePath,
}

func (e ComponentSourceOrderable) IsValid() bool {
	switch e {
	case ComponentSourceOrderableXid, ComponentSourceOrderableURL, ComponentSourceOrderablePermaURL, ComponentSourceOrderableName, ComponentSourceOrderableTag, ComponentSourceOrderablePath:
		return true
	}
	return false
}

func (e ComponentSourceOrderable) String() string {
	return string(e)
}

func (e *ComponentSourceOrderable) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = ComponentSourceOrderable(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid ComponentSourceOrderable", str)
	}
	return nil
}

func (e ComponentSourceOrderable) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
...
func (e DocumentationReadinessLevel) IsValid() bool {
	switch e {
	case DocumentationReadinessLevelOdrl1, DocumentationReadinessLevelOdrl2, DocumentationReadinessLevelOdrl3, DocumentationReadinessLevelOdrl4, DocumentationReadinessLevelOdrl5:
		return true
	}
	return false
}
...
func (e FileHasFilter) IsValid() bool {
	switch e {
	case FileHasFilterDiscoveredAt, FileHasFilterLastIndexedAt, FileHasFilterDataSource, FileHasFilterName, FileHasFilterPath, FileHasFilterMimeType, FileHasFilterURL, FileHasFilterCreatedAt:
		return true
	}
	return false
}
...
func (e FileOrderable) IsValid() bool {
	switch e {
	case FileOrderableDiscoveredAt, FileOrderableLastIndexedAt, FileOrderableName, FileOrderablePath, FileOrderableMimeType, FileOrderableURL, FileOrderableCreatedAt:
		return true
	}
	return false
}
...
func (e GroupHasFilter) IsValid() bool {
	switch e {
	case GroupHasFilterXid, GroupHasFilterHost, GroupHasFilterName, GroupHasFilterEmail, GroupHasFilterAvatar, GroupHasFilterURL, GroupHasFilterMemberOf, GroupHasFilterProducts, GroupHasFilterMembers:
		return true
	}
	return false
}
...
func (e GroupOrderable) IsValid() bool {
	switch e {
	case GroupOrderableXid, GroupOrderableName, GroupOrderableEmail, GroupOrderableURL:
		return true
	}
	return false
}
...
const (
	...
	ProductHasFilterOwner         ProductHasFilter = "owner"
...
func (e ProductHasFilter) IsValid() bool {
	switch e {
	case ProductHasFilterDiscoveredAt, ProductHasFilterLastIndexedAt, ProductHasFilterDataSource, ProductHasFilterXid, ProductHasFilterName, ProductHasFilterOwner, ProductHasFilterDescription, ProductHasFilterWebsite, ProductHasFilterVersion, ProductHasFilterRelease, ProductHasFilterReleases, ProductHasFilterRenamedTo, ProductHasFilterRenamedFrom, ProductHasFilterForkOf, ProductHasFilterForks, ProductHasFilterTags, ProductHasFilterCategory:
		return true
	}
	return false
}
...
func (e ProductOrderable) IsValid() bool {
	switch e {
	case ProductOrderableDiscoveredAt, ProductOrderableLastIndexedAt, ProductOrderableXid, ProductOrderableName, ProductOrderableDescription, ProductOrderableWebsite, ProductOrderableVersion:
		return true
	}
	return false
}
...
func (e TechnologyReadinessLevel) IsValid() bool {
	switch e {
	case TechnologyReadinessLevelOtrl1, TechnologyReadinessLevelOtrl2, TechnologyReadinessLevelOtrl3, TechnologyReadinessLevelOtrl4, TechnologyReadinessLevelOtrl5:
		return true
	}
	return false
}
...
func (e UserHasFilter) IsValid() bool {
	switch e {
	case UserHasFilterXid, UserHasFilterHost, UserHasFilterName, UserHasFilterEmail, UserHasFilterAvatar, UserHasFilterURL, UserHasFilterMemberOf, UserHasFilterProducts, UserHasFilterFullName, UserHasFilterLocale:
		return true
	}
	return false
}
...
func (e UserOrGroupHasFilter) IsValid() bool {
	switch e {
	case UserOrGroupHasFilterXid, UserOrGroupHasFilterHost, UserOrGroupHasFilterName, UserOrGroupHasFilterEmail, UserOrGroupHasFilterAvatar, UserOrGroupHasFilterURL, UserOrGroupHasFilterMemberOf, UserOrGroupHasFilterProducts:
		return true
	}
	return false
}
...
func (e UserOrGroupOrderable) IsValid() bool {
	switch e {
	case UserOrGroupOrderableXid, UserOrGroupOrderableName, UserOrGroupOrderableEmail, UserOrGroupOrderableURL:
		return true
	}
	return false
}
...
func (e UserOrderable) IsValid() bool {
	switch e {
	case UserOrderableXid, UserOrderableName, UserOrderableEmail, UserOrderableURL, UserOrderableFullName, UserOrderableLocale:
		return true
	}
	return false
}
