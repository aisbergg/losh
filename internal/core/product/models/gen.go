...
type AddComponentInput struct {
	...
	Description string         `json:"description"`
	Owner       UserOrGroupRef `json:"owner"`
	...
	AdditionalLicenses []*LicenseRef  `json:"additionalLicenses"`
	...
	UsedIn                    []*ComponentRef                             `json:"usedIn"`
	Source                    *FileRef                                    `json:"source,omitempty"`
	Export                    []*FileRef                                  `json:"export"`
	Auxiliary                 []*FileRef                                  `json:"auxiliary"`
	...
	ProductionMetadata   []*KeyValueRef           `json:"productionMetadata"`
}
...
type AddGroupInput struct {
	...
	MemberOf []*GroupRef       `json:"memberOf"`
	Products []*ProductRef     `json:"products,omitempty"`
	Members  []*UserOrGroupRef `json:"members"`
}
...
type AddTagInput struct {
	...
	// The name of the tag.
	Name    string    `json:"name"`
	Aliases []*TagRef `json:"aliases"`
	Related []*TagRef `json:"related"`
}
...
const (
	...
	RepositoryHasFilterTag      RepositoryHasFilter = "tag"
...
var AllRepositoryHasFilter = []RepositoryHasFilter{
	...
	RepositoryHasFilterTag,
	RepositoryHasFilterPath,
}

func (e RepositoryHasFilter) IsValid() bool {
	switch e {
	case RepositoryHasFilterXid, RepositoryHasFilterURL, RepositoryHasFilterPermaURL, RepositoryHasFilterHost, RepositoryHasFilterOwner, RepositoryHasFilterName, RepositoryHasFilterTag, RepositoryHasFilterPath:
		return true
	}
	return false
}
...
const (
	...
	RepositoryOrderableTag      RepositoryOrderable = "tag"
...
var AllRepositoryOrderable = []RepositoryOrderable{
	...
	RepositoryOrderableTag,
	RepositoryOrderablePath,
}

func (e RepositoryOrderable) IsValid() bool {
	switch e {
	case RepositoryOrderableXid, RepositoryOrderableURL, RepositoryOrderablePermaURL, RepositoryOrderableName, RepositoryOrderableTag, RepositoryOrderablePath:
		return true
	}
	return false
}
