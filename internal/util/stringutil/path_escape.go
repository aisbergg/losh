...
// EscapePath escapes a string as `systemd-escape --path` would
func EscapePath(unescaped string) string {
	return escape(unescaped, true)
}

// UnescapePath unescapes a string as `systemd-escape --path --unescape` would
