...
import (
	"log"
	Controller "losh/web/app/controllers/web"
	"losh/web/database"
...
func RegisterHome(web fiber.Router, session *session.Store, sessionLookup string, db *database.Database, hasher hashing.Driver) {
	// Homepage
